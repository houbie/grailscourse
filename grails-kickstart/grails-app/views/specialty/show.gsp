...
<html>
    ...
    <body>
        ...
        <div id="show-specialty" class="content scaffold-show" role="main">
            ...
            <f:display bean="specialty" />
            </ol>
            <g:form resource="${specialty}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${specialty}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
